    ...
    <header className="flex items-center justify-between p-6 md:p-8 relative z-50">
      ...
      <nav className="hidden md:flex items-center justify-center flex-1">
        <div className="flex items-center space-x-8 backdrop-blur-md rounded-full px-6 py-2" style={{backgroundColor: 'rgba(251, 191, 36, 0.3)'}}>
          ...
          {/* Instagram Icon */}
          <Link href="https://instagram.com/nicolasvivaudou" target="_blank" className="text-white hover:text-blue-300 transition-colors">
      ...
      {isMenuOpen && (
        <div className="md:hidden absolute top-full left-0 right-0 backdrop-blur-md z-20" style={{backgroundColor: 'rgba(251, 191, 36, 0.3)'}}>
